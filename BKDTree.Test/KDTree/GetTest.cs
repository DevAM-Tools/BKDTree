...
public class GetTest
{
    ...
    public async Task GetRange(Pattern xPattern, Pattern yPattern, bool parallel, double? lowerLimitShareX, double? lowerLimitShareY, double? upperLimitShareX, double? upperLimitShareY)
    {
        int[] counts = [10, 500];
